...
export function IconCloud({ icons, images }: IconCloudProps) {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < numIcons; i++) {
            ...
            // Stretch the x-axis to make it more elliptical (reduced stretch factor)
            newIcons.push({
                x: x * radius * 1.2, // Reduced from 1.3 to 1.2 to make it less wide
                y: y * radius * 0.9,
                z: z * radius,
                scale: 1,
                opacity: 1,
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            sortedIcons.forEach((icon, index) => {
                ...
                const scale = (rotatedZ + 200) / 300;
                const opacity = Math.max(0.4, Math.min(1, (rotatedZ + 150) / 200)); // Increased minimum opacity
